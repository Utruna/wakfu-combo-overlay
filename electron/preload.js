...
contextBridge.exposeInMainWorld('settingsAPI', {
  ...
  addHero: (hero, options) => ipcRenderer.invoke('settings:addHero', hero, options),
  updateHero: (characterName, changes) => ipcRenderer.invoke('settings:updateHero', characterName, changes),
  setOnboardingDone: () => ipcRenderer.invoke('settings:setOnboardingDone'),
  ...
  showObsLoader: () => ipcRenderer.invoke('settings:showObsLoader'),
